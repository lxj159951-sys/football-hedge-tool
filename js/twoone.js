...
const TwoOne = {
    ...
    bindEvents() {
        const calculateBtn = document.getElementById('calculateTwoOne');
        if (calculateBtn) {
    ...
    calculate() {
        // 获取输入值
        const team1 = document.getElementById('twoOneTeam1').value.trim() || '比赛1';
        const team2 = document.getElementById('twoOneTeam2').value.trim() || '比赛2';
        const odds1 = parseFloat(document.getElementById('twoOneOdds1').value);
        const odds2 = parseFloat(document.getElementById('twoOneOdds2').value);
        const stake = parseFloat(document.getElementById('twoOneStake').value);
        const cf = parseFloat(document.getElementById('twoOneCF').value) || 14;
    ...
    displayResult(result) {
        const resultCard = document.getElementById('twoOneResult');
        const resultBody = document.getElementById('twoOneResultBody');
        ...
        resultBody.innerHTML = `
            ...
            <div class="result-actions">
                <button class="btn btn-primary" onclick="TwoOne.savePlan()">
                    <i class="fas fa-save"></i> 保存方案
                </button>
                <button class="btn btn-secondary" onclick="TwoOne.reset()">
    ...
    reset() {
        document.getElementById('twoOneTeam1').value = '';
        document.getElementById('twoOneTeam2').value = '';
        document.getElementById('twoOneOdds1').value = '';
        document.getElementById('twoOneOdds2').value = '';
        document.getElementById('twoOneStake').value = '';
        document.getElementById('twoOneResult').style.display = 'none';
